 ...
 */
namespace Sincco\Imageclean\Helper;
...
class Data extends AbstractHelper {
	...
	{
		$pathOfMedia = $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'pub'.DIRECTORY_SEPARATOR.'media'.DIRECTORY_SEPARATOR.'catalog'.DIRECTORY_SEPARATOR.'product';
        if (is_dir($path))
		{
            if ($dir = opendir($path))
			{
    ...
    public function compareList()
	{
        ...
        $pepe = $_SERVER['DOCUMENT_ROOT'].DIRECTORY_SEPARATOR.'pub'.DIRECTORY_SEPARATOR.'media'.DIRECTORY_SEPARATOR.'catalog'.DIRECTORY_SEPARATOR.'product';
